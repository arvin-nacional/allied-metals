            ...
            {milestones &&
              milestones.map((milestone, index) => {
                ...
                return (
                  <div 
                    key={milestone.id} 
                    ref={(el: HTMLDivElement | null) => { milestoneRefs.current[index] = el }}
                    ...
                    {index % 2 === 0 ? (
                      ...
                      <>
                        ...
                        <div className="md:w-12 flex justify-center order-1 md:order-2">
                          <div className={`w-10 h-10 bg-[#00a0e4] rounded-full flex items-center justify-center z-10 transition-transform duration-1000 ${isVisible ? 'scale-100' : 'scale-0'}`}>
